...
var (
	file_io_prometheus_write_v2_types_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
	file_io_prometheus_write_v2_types_proto_msgTypes  = make([]protoimpl.MessageInfo, 7)
	file_io_prometheus_write_v2_types_proto_goTypes   = []interface{}{
