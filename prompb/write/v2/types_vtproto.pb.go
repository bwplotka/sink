...
func (m *Histogram) CloneVT() *Histogram {
	...
	if rhs := m.CustomBounds; rhs != nil {
		tmpContainer := make([]float64, len(rhs))
		copy(tmpContainer, rhs)
		r.CustomBounds = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *TimeSeries) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CreatedTimestamp != 0 {
		i = encodeVarint(dAtA, i, uint64(m.CreatedTimestamp))
		i--
		dAtA[i] = 0x30
	}
	if m.Metadata != nil {
...
func (m *Metadata) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.UnitRef != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UnitRef))
		i--
		dAtA[i] = 0x20
	}
	if m.HelpRef != 0 {
		i = encodeVarint(dAtA, i, uint64(m.HelpRef))
		i--
		dAtA[i] = 0x18
	}
	if m.Type != 0 {
...
func (m *Histogram) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.CustomBounds) > 0 {
		for iNdEx := len(m.CustomBounds) - 1; iNdEx >= 0; iNdEx-- {
			f1 := math.Float64bits(float64(m.CustomBounds[iNdEx]))
			i -= 8
			binary.LittleEndian.PutUint64(dAtA[i:], uint64(f1))
		}
		i = encodeVarint(dAtA, i, uint64(len(m.CustomBounds)*8))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (m *TimeSeries) SizeVT() (n int) {
	...
	if m.CreatedTimestamp != 0 {
		n += 1 + sov(uint64(m.CreatedTimestamp))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Metadata) SizeVT() (n int) {
	...
	if m.HelpRef != 0 {
		n += 1 + sov(uint64(m.HelpRef))
	}
	if m.UnitRef != 0 {
		n += 1 + sov(uint64(m.UnitRef))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *Histogram) SizeVT() (n int) {
	...
	if len(m.CustomBounds) > 0 {
		n += 2 + sov(uint64(len(m.CustomBounds)*8)) + len(m.CustomBounds)*8
	}
	n += len(m.unknownFields)
	return n
}
